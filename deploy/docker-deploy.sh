#!/bin/bash
# =============================================================================
# QQQ2API Docker Deployment Preparation Script
# =============================================================================
# This script prepares deployment files for QQQ2API:
...
GITHUB_RAW_URL="https://raw.githubusercontent.com/th3ee9ine/qqq2api/main/deploy"
...
main() {
    echo ""
    echo "=========================================="
    echo "  QQQ2API Deployment Preparation"
    echo "=========================================="
    echo ""
