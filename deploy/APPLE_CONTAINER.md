...
```dotenv
APPLE_CONTAINER_SUB2API_IMAGE=ghcr.io/th3ee9ine/sub2api:latest
...
SUB2API_IMAGE=ghcr.io/th3ee9ine/sub2api:latest # Match APPLE_CONTAINER_SUB2API_IMAGE in .env.
