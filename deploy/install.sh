#!/bin/bash
#
# QQQ2API Installation Script
# QQQ2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/th3ee9ine/qqq2api/main/deploy/install.sh | bash
#
...
declare -A MSG_ZH=(
    ...
    # Completion
    ["install_complete"]="QQQ2API 安装完成！"
    ["install_dir"]="安装目录"
    ["next_steps"]="后续步骤"
    ["step1_check_services"]="确保 PostgreSQL 和 Redis 正在运行："
    ["step2_start_service"]="启动 QQQ2API 服务："
    ...
    ["not_installed"]="QQQ2API 尚未安装，请先执行全新安装"
    ["fresh_install_hint"]="用法"

    # Uninstall
    ["uninstall_confirm"]="这将从系统中移除 QQQ2API。"
    ...
    ["uninstall_complete"]="QQQ2API 已卸载"

    # Help
    ["usage"]="用法"
    ["cmd_none"]="(无参数)"
    ["cmd_install"]="安装 QQQ2API"
    ["cmd_upgrade"]="升级到最新版本"
    ["cmd_uninstall"]="卸载 QQQ2API"
    ...
    ["server_config_desc"]="配置 QQQ2API 服务监听地址"
...
declare -A MSG_EN=(
    ...
    # Installation
    ["install_title"]="QQQ2API Installation Script"
    ...
    # Completion
    ["install_complete"]="QQQ2API installation completed!"
    ["install_dir"]="Installation directory"
    ["next_steps"]="NEXT STEPS"
    ["step1_check_services"]="Make sure PostgreSQL and Redis are running:"
    ["step2_start_service"]="Start QQQ2API service:"
    ...
    ["not_installed"]="QQQ2API is not installed. Please run a fresh install first"
    ["fresh_install_hint"]="Usage"

    # Uninstall
    ["uninstall_confirm"]="This will remove QQQ2API from your system."
    ...
    ["uninstall_complete"]="QQQ2API has been uninstalled"

    # Help
    ["usage"]="Usage"
    ["cmd_none"]="(none)"
    ["cmd_install"]="Install QQQ2API"
    ["cmd_upgrade"]="Upgrade to the latest version"
    ["cmd_uninstall"]="Remove QQQ2API"
    ...
    ["server_config_desc"]="Configure QQQ2API server listen address"
...
[Unit]
Description=QQQ2API - AI API Gateway Platform
Documentation=https://github.com/th3ee9ine/qqq2api
...
# Requires: QQQ2API must already be installed
install_version() {
