export default {
    accounts: {
      ...
      dataExportedSkippedShadows: 'Data exported. Skipped {count} spark shadow account(s): their scheduling config is not included in the export; recreate and re-tune them after import.',
      ...
      dataImportAutoAssignProxy: 'Auto-assign available proxies to imported accounts',
      dataImportAutoAssignProxyHint: 'Ignores account proxy bindings in the file and assigns active proxies with available capacity, least-used first.',
      ...
      usageWindowsHint: '"5h / 7d" are the upstream account\'s official rolling usage windows (e.g. OpenAI ChatGPT, Claude). They are imposed by the upstream provider on the account itself — not configured by QQQ2API, and unrelated to the models you map. Usage resets automatically once each window rolls over, and the limit cannot be lifted from within QQQ2API.',
      proxyDetailsUnavailable: 'Proxy details unavailable',
      upstreamBilling: {
      ...
      refreshSubscription: 'Refresh Subscription Expiry',
      refreshSubscriptionSuccess: 'GPT subscription expiry updated',
      refreshSubscriptionFailed: 'Failed to fetch GPT subscription expiry',
      ...
      grok: {
        ...
        ttsTextPlaceholder: 'Example: Hello from API connectivity test.',
        ttsTextDefault: 'Hello from API account connectivity test.',
      ...
      anthropic: {
        ...
        apiKeyAuthSchemeDesc: 'Choose the API key auth header used when forwarding to an Anthropic-compatible upstream.',
      ...
      poolModeInfo:
        'When enabled, upstream 429/403/401 errors will auto-retry without marking the account as rate-limited or errored. Suitable for upstream pointing to another QQQ2API instance.',
      ...
      proxy: 'Proxy',
      noProxy: 'No Proxy',
      manualAssignProxy: 'Choose a proxy manually',
      autoAssignProxy: 'Auto-assign an available proxy',
      autoAssignProxyHint: 'On save, chooses an active proxy with available capacity, preferring the proxy currently used by fewer accounts.',
      autoAssignProxyCapacityInsufficient: 'Active proxies do not have enough remaining capacity. Increase capacity or choose a proxy manually.',
      ...
      sessions: {
        action: 'Signed-in Devices',
        title: 'Active Device Sessions',
        description: 'Review browsers and first-party OpenAI apps currently signed in to this GPT account. Device and location details may be approximate.',
        refresh: 'Refresh',
        selectAll: 'Select revokable sessions',
        selectedCount: '{count} selected',
        logoutSelected: 'Log out selected',
        logoutSelectedTitle: 'Log Out Device Sessions',
        logoutSelectedConfirm: 'Log out the selected {count} device sessions? The current session will not be affected.',
        logoutSelectedSuccess: 'Logged out {count} device sessions',
        logoutPartialSuccess: 'Logged out {success} sessions; {failed} failed. Refresh and retry the failed sessions.',
        ...
        logout: 'Log out',
        logoutTitle: 'Log Out Device Session',
        logoutConfirm: 'Log “{device}” out of this GPT account?',
        logoutSuccess: 'Device session logged out',
        loadFailed: 'Failed to load active sessions',
        logoutFailed: 'Failed to log out device session',
        errors: {
          OPENAI_SESSIONS_PROXY_UNAVAILABLE: 'The account proxy could not connect to ChatGPT. Test or replace the proxy and retry.',
          OPENAI_SESSIONS_UPSTREAM_ERROR: 'OpenAI rejected the session query. Refresh the account authorization or replace the proxy and retry.',
          OPENAI_SESSIONS_INVALID_RESPONSE: 'OpenAI returned an unsupported device-session format.',
          OPENAI_SESSIONS_AUTH_FAILED: 'The account authorization is unavailable. Re-authorize the account and retry.',
      ...
      stats: {
        ...
        totalEarnings: '30-Day Total Earnings',
        ...
        avgDailyEarnings: 'Daily Avg Earnings',
        ...
        highestEarningsDay: 'Highest Earnings Day',
        ...
        earningsTrend: '30-Day Earnings & Request Trend',
