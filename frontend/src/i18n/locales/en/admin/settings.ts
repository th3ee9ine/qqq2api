export default {
    settings: {
      ...
      gatewayForwarding: {
        ...
        openaiCodexClientVersion: 'Codex unified version hotfix',
        openaiCodexClientVersionPlaceholder: 'Leave empty for official auto-sync',
        openaiCodexClientVersionHint: 'Normally leave this empty. A valid stable release can be entered as an emergency version floor. The leading User-Agent engine and Responses/WS Version always share the highest valid version among this value, the official sync, and the built-in floor, so stale values cannot downgrade the outbound identity.',
        openaiCodexVersionAutoSync: 'Auto-sync official Codex version',
        openaiCodexVersionAutoSyncHint: 'Fetches the latest stable rust-v from the official repository every 6 hours and updates both the leading User-Agent engine and Responses/WS Version. Originator remains paired with the UA client name, while the Desktop trailer app build stays independent.',
