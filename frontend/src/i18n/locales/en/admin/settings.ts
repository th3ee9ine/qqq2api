export default {
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for QQQ2API end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for QQQ2API end-user login',
      ...
      scheduling: {
        ...
        accountSchedulingThresholdsDescription: 'When an account\'s current OpenAI Codex or Anthropic usage window reaches this percent, QQQ2API temporarily removes it from scheduling until the window resets. Use 100 to disable.',
      ...
      gatewayForwarding: {
        ...
        openaiCodexIdentityHint: 'Configure the global client identity used for GPT/Codex calls to OpenAI upstream. Built-in canonical templates cover Codex Desktop, macOS TUI, and Ubuntu CLI, keeping Originator, User-Agent, and Version consistent. When account device-session identity is enabled and valid, the account identity triple takes precedence.',
        ...
        openaiCodexUserAgentHint: 'The complete UA must begin with client/version. The menu contains three canonical identity templates. Choosing one also sets Originator; choosing Version updates the UA engine and TUI trailer while preserving the independent Desktop app build. Other client identities can still be entered manually.',
        ...
        openaiCodexOriginatorPresets: 'Choose a canonical identity (or type below)',
        openaiCodexUserAgentPresets: 'Choose a canonical UA template using the current Version',
        openaiCodexTemplate: 'Canonical template',
      ...
      payment: {
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on QQQ2API orders; the upstream type is sent as EasyPay type.',
