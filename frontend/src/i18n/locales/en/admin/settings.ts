export default {
    settings: {
      ...
      gatewayForwarding: {
        ...
        codexTurnStateHint: "Automatically collect, obtain and renew Turn State per account. No token entry is needed.",
        ...
        codexTurnStateDefaultModelHint: "Used for automatic acquisition, renewal, 312 recovery and IP pool probes. Enter a full model name supported by the account; leave blank to restore gpt-5.5. Saved changes apply to subsequent probes.",
