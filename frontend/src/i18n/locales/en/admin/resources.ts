export default {
    ...
    usage: {
      ...
      upstreamTurnState: 'Upstream Turn State',
      turnStateNotSent: 'Not sent',
      turnStateUnknown: 'Not recorded',
      turnStateCopied: 'Turn State copied',
      turnStateViewDetails: 'View Turn State details',
      turnStateDetails: 'Turn State details',
      turnStateLength: 'Length',
      turnStateHandshakeHint: 'WebSocket shows the state sent in its handshake; reused connections do not resend headers per turn.',
      upstreamOriginator: 'Upstream Originator',
      upstreamUserAgent: 'Upstream User-Agent',
      upstreamVersion: 'Upstream Version',
      upstreamOriginatorDetails: 'Upstream Originator details',
      upstreamUserAgentDetails: 'Upstream User-Agent details',
      upstreamVersionDetails: 'Upstream Version details',
      upstreamHeaderViewDetails: 'View upstream request-header details',
      upstreamHeaderNotSent: 'Not sent',
      upstreamHeaderUnknown: 'Not recorded',
      upstreamHeaderCopied: 'Upstream header copied',
