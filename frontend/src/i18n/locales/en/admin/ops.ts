export default {
    ops: {
      ...
      errorLog: {
        ...
        requestTypeWs: 'WS',
        exportExcel: 'Export error logs'
      },
      // Error log export columns.
      errorExport: {
        id: 'Error ID',
        time: 'Time',
        phase: 'Phase',
        ...
        upstreamEvents: 'Upstream Events',
        authLatency: 'Auth Latency (ms)',
        routingLatency: 'Routing Latency (ms)',
        upstreamLatency: 'Upstream Latency (ms)',
        responseLatency: 'Response Latency (ms)',
        timeToFirstToken: 'Time to First Token (ms)',
        userAgent: 'User-Agent',
        clientIp: 'Client IP',
        resolved: 'Resolved',
        businessLimited: 'Business Limited',
        requestDetails: 'User Request Details',
        requestDetailsChunked: 'Content split into {count} chunks; see the “Request Details” worksheet',
        fieldChunked: '{field} split into {count} chunks; see the “Oversized Fields” worksheet',
        detailSheetErrorId: 'Error ID',
        detailSheetRequestId: 'Request ID',
        detailSheetField: 'Field',
        detailSheetChunk: 'Chunk',
