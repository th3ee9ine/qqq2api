export default {
    ...
    riskControl: {
      ...
      protocolHint: 'Use Moderations for a native moderation endpoint, or Chat Completions/Responses for OpenAI-compatible classifiers such as qqqrouter.',
      protocolModerations: 'OpenAI Moderations (/v1/moderations)',
      protocolChatCompletions: 'Chat Completions (/v1/chat/completions)',
