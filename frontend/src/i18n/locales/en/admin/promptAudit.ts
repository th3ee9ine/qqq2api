export default {
  promptAudit: {
    ...
    localGuard: {
      ...
      pageDescription: 'View local prompt-injection protection status and coverage for API ingress.',
      description: 'A deterministic local guard runs before the optional remote Prompt Audit dependency to block high-confidence prompt-injection and jailbreak instructions.',
      enabled: 'Enabled',
      disabled: 'Disabled',
      unavailable: 'Degraded',
      disabledByAdmin: 'Disabled by administrator',
      disabledAction: 'Rules inactive',
      toggle: 'Enable local jailbreak guard',
      switchHint: 'When disabled, local rules do not block prompt injection; remote Prompt Audit continues according to its independent configuration.',
      saveError: 'The local jailbreak guard switch could not be saved. Refresh and try again.',
      execution: 'Execution',
      alwaysOn: 'Always on',
      policy: 'Policy ID',
      action: 'On match',
      ...
      behaviors: {
        instructionOverride: 'Detects instruction-override language such as “ignore previous instructions”.',
    ...
    events: {
      title: 'Audit events', description: 'Review events by API Key, group, route, risk, hash, and time; the detail view shows the full prompt.', decision: 'Decision', risk: 'Risk level', endpoint: 'Endpoint', groupId: 'Group ID', apiKeyId: 'API Key ID', keyword: 'Keyword',
      ...
      moreConditions: 'More conditions (endpoint / keyword / group / API Key)',
      ...
      selectAll: 'Select all events on this page', selectEvent: 'Select event {id}', time: 'Time', identity: 'API Key', apiKey: 'API Key name', group: 'Group', route: 'Endpoint / model', result: 'Decision / risk', preview: 'Redacted preview', empty: 'No matching events.',
