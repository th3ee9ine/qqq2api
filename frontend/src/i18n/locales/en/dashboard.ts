export default {
  ...
  keys: {
    ...
    description: 'Manage API keys shared across the entire system',
    ...
    concurrencyLimitHint: 'Maximum concurrent requests for this key. 0 means unlimited.',
    concurrencyLimitInvalid: 'Concurrency limit must be a non-negative integer',
    saving: 'Saving...',
    ...
    useKeyModal: {
      ...
      grok: {
        description:
          'Configure Grok CLI, Claude Code, Codex, or OpenCode to send requests through your QQQ2API Grok group. Text models use Responses; image/video use Imagine model IDs on media endpoints.',
        claudeDescription: 'Configure Claude Code to send Messages API traffic through your QQQ2API Grok group.',
        codexDescription: 'Configure Codex to send Responses API traffic through your QQQ2API Grok group.',
        configTomlHint:
        ...
        codexConfigTomlHint:
          'Official Codex: wire_api = "responses" only; prefer env_key over experimental_bearer_token; supports_websockets = false for non-OpenAI gateways (QQQ2API can still accept client WS and bridge to HTTP/SSE). Back up ~/.codex/config.toml before merge.',
        note:
  ...
  usage: {
    ...
    userAgentViewDetails: 'View User-Agent details',
    userAgentDetails: 'User-Agent details',
