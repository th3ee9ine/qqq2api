export default {
    ops: {
      ...
      // Error log export columns.  Keep these separate from table labels so
      // the workbook remains explicit even when a table column is hidden.
      errorExport: {
        id: '错误 ID',
        time: '时间',
        phase: '阶段',
        ...
        upstreamEvents: '上游事件',
        authLatency: '认证耗时（毫秒）',
        routingLatency: '路由耗时（毫秒）',
        upstreamLatency: '上游耗时（毫秒）',
        responseLatency: '响应耗时（毫秒）',
        timeToFirstToken: '首 Token 耗时（毫秒）',
        userAgent: 'User-Agent',
        clientIp: '客户端 IP',
        resolved: '已解决',
        businessLimited: '业务限制',
        requestDetails: '用户请求明细',
        requestDetailsChunked: '内容已拆分为 {count} 段，请查看“Request Details”工作表',
        fieldChunked: '{field} 已拆分为 {count} 段，请查看“Oversized Fields”工作表',
        detailSheetErrorId: '错误 ID',
        detailSheetRequestId: '请求 ID',
        detailSheetField: '字段',
        detailSheetChunk: '分段序号',
