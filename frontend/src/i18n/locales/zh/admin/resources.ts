export default {
    ...
    proxies: {
      title: 'IP管理',
      description: '统一管理代理资源，掌握连接质量与账号分配情况。',
      eyebrow: '网络资源',
      listTitle: '代理列表',
      selectionCount: '已选择 {count} 项',
      selectionHint: '选择代理以批量管理',
      clearSelection: '清除选择',
      selectPage: '选择本页全部代理',
      selectProxy: '选择代理 {name}',
      resetFilters: '重置筛选',
      probeSelected: '检测选中的代理',
      probeFiltered: '检测当前筛选范围内的全部代理',
      noMatchingProxies: '未找到匹配的代理',
      tryOtherFilters: '调整搜索词或筛选条件，查看其他代理。',
      unknownLocation: '暂无位置',
      notMeasured: '未检测',
      showPassword: '显示密码',
      hidePassword: '隐藏密码',
      overview: {
        ...
        pageHint: '当前页的启用代理',
        accounts: '本页关联账号',
        accountsHint: '当前页代理的账号总数',
        attention: '本页待关注',
        attentionHint: '已过期或连接失败',
      },
      createProxy: '添加代理',
      editProxy: '编辑代理',
      deleteProxy: '删除代理',
      ...
      host: '主机',
      port: '端口',
      maxAccounts: '自动分配账号上限',
      maxAccountsHint: '设置自动分配时该代理可承载的账号数上限；不影响手工指定代理，填写 0 表示不限制。',
      unlimited: '不限制',
      username: '用户名（可选）',
      password: '密码（可选）',
      status: '状态',
      ...
      batchMaxAccounts: '批量修改账号上限',
      batchMaxAccountsDescription: '将修改选中的 {count} 个代理的自动分配账号上限。填写 0 表示不限制。',
      batchMaxAccountsDone: '已更新 {updated} 个代理，跳过 {skipped} 个',
      batchMaxAccountsSkipped: '已跳过 {skipped} 个代理',
      batchMaxAccountsFailed: '批量修改账号上限失败',
      ...
      bindings: {
        manage: '管理绑定账号',
        title: '账号绑定管理',
        description: '查看使用此 IP 的账号，支持单个或批量解绑、换绑。选择主账号即可同步调整其影子账号。',
        source: '当前 IP',
        boundAccounts: '绑定账号 · 含影子账号',
        search: '搜索账号名称、ID、平台或备注',
        selectedCount: '已选 {count} 个主账号',
        selectedAccounts: '本次操作 · {count} 个主账号',
        selectAll: '全选当前结果中的主账号',
        selectAccount: '选择账号 {name}',
        noMatches: '没有匹配的账号，试试其他搜索词。',
        emptyHint: '可在账号管理中为账号指定此 IP。',
        shadowAccount: '影子账号 · 跟随主账号 #{id}，请操作对应主账号。',
        shadowSync: '主账号的影子账号会同步更新代理配置，无需单独选择。',
        unlink: '解绑',
        rebind: '换绑',
        bulkUnlink: '批量解绑',
        bulkRebind: '批量换绑',
        unlinkTitle: '解绑 {count} 个主账号',
        rebindTitle: '换绑 {count} 个主账号',
        unlinkDescription: '解绑会移除所选账号的代理配置，后续请求将按无代理方式连接。请确认这些账号可在无代理环境下使用。',
        rebindDescription: '将所选账号切换到另一个 IP，后续请求使用目标代理连接。',
        target: '目标 IP',
        selectTarget: '选择目标 IP',
        searchTarget: '搜索 IP 名称、主机或端口',
        targetCapacity: '账号 {count} / {max}',
        targetsHint: '仅展示其他已启用且未过期的 IP；账号数 / 自动分配上限仅供参考。',
        noTargets: '暂无可换绑的目标 IP，请先添加或启用一个未过期的代理。',
        targetsFailed: '获取目标 IP 列表失败，请重试。',
        capacityWarning: '换绑后可能超过目标 IP 的自动分配账号上限。手工指定不受该上限限制，仍可继续换绑。',
        afterChange: '变更后',
        noProxy: '无代理连接',
        confirmUnlink: '确认解绑 {count} 个账号',
        confirmRebind: '确认换绑 {count} 个账号',
        submitting: '正在处理，请稍候…',
        sourceChanged: '部分账号的绑定关系已发生变化，列表已刷新，并保留仍绑定此 IP 的选择。请核对后重新操作。',
        targetUnavailable: '目标 IP 已停用、过期或被删除，请重新选择。',
        invalidInput: '账号绑定参数无效，请返回列表重新选择账号和目标 IP。',
        accountUnavailable: '部分账号已删除或不存在，请刷新账号列表并重新选择。',
        preflightFailed: '未能确认最新的账号绑定或目标 IP 状态，本次未提交变更，请重试。',
        unlinkSuccess: '已解绑 {count} 个主账号，影子账号同步更新。',
        rebindSuccess: '已换绑 {count} 个主账号，影子账号同步更新。',
        partialResult: '操作结果：成功 {success} 个，失败 {failed} 个。请检查失败详情及最新账号列表。',
        unknownResult: '未能确认所有账号的处理结果，请核对刷新后的绑定列表再操作。',
        operationFailed: '账号绑定变更未能全部完成。',
        reviewAfterFailure: '请以刷新后的绑定状态为准；核对账号列表和失败原因后，再决定是否重试。',
      },
      // Batch import
      standardAdd: '标准添加',
      batchAdd: '快捷添加',
      ...
      batchMaxAccountsHint: '该上限将应用于本次快捷添加的每个代理，填写 0 表示不限制。',
      ...
      maxAccountsInvalid: '自动分配账号上限必须是非负整数',
    ...
    usage: {
      ...
      upstreamTurnState: '上游 Turn State',
      turnStateNotSent: '未携带',
      turnStateUnknown: '未记录',
      turnStateCopied: 'Turn State 已复制',
      turnStateViewDetails: '点击查看 Turn State 详情',
      turnStateDetails: 'Turn State 详情',
      turnStateLength: '长度',
      turnStateHandshakeHint: 'WebSocket 使用建连时发送的 Turn State；复用连接的后续轮次不重复发送请求头。',
      upstreamOriginator: '上游 Originator',
      upstreamUserAgent: '上游 User-Agent',
      upstreamVersion: '上游 Version',
      upstreamOriginatorDetails: '上游 Originator 详情',
      upstreamUserAgentDetails: '上游 User-Agent 详情',
      upstreamVersionDetails: '上游 Version 详情',
      upstreamHeaderViewDetails: '点击查看上游请求头详情',
      upstreamHeaderNotSent: '未携带',
      upstreamHeaderUnknown: '未记录',
      upstreamHeaderCopied: '上游请求头已复制',
      allModels: '全部模型',
      allAccounts: '全部账户',
      allGroups: '全部分组',
      allTypes: '全部类型',
