  ...
  <div>
    ...
    >
      <label
        ...
        :title="authStore.isAccountAdmin || group.rate_multiplier == null
          ? group.name
      ...
      >
        ...
        />
        <span v-if="!authStore.isAccountAdmin" class="shrink-0 text-xs text-gray-400">{{ group.account_count || 0 }}</span>
      </label>
      <div
