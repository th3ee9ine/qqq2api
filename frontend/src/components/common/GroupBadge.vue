<template>
  ...
  >
    <!-- Platform logo -->
    <PlatformIcon v-if="platform" :platform="badgePlatform" size="sm" />
    <!-- Group name -->
...
const labelClass = computed(() => {
  ...
  return `${base} bg-gray-200/60 text-gray-700 dark:bg-gray-700/60 dark:text-gray-300`
})
...
const badgeClass = computed(() => {
  ...
  // Unsupported legacy groups are displayed neutrally and remain delete-only.
  return isSubscription.value
