              ...
              <template v-if="form.payment_enabled">
                ...
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-3">
                  ...
                  <div>
                    ...
                    >
                      {{
                        (form.payment_product_name_prefix || "QQQ2API") +
                        " 100 " +
...
const paymentGuideHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/th3ee9ine/qqq2api/blob/main/docs/PAYMENT_CN.md"
    : "https://github.com/th3ee9ine/qqq2api/blob/main/docs/PAYMENT.md",
);

const paymentMethodsHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/th3ee9ine/qqq2api/blob/main/docs/PAYMENT_CN.md#支持的支付方式"
    : "https://github.com/th3ee9ine/qqq2api/blob/main/docs/PAYMENT.md#supported-payment-methods",
);
...
> & {
  ...
  // 系统全局平台限额 map；form 内始终归一化为所有受支持平台对象（模板非空绑定依赖此不变量）
