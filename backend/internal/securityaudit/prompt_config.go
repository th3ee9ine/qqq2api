...
type storageConfig struct {
	...
	LocalJailbreakGuardEnabled bool              `json:"local_jailbreak_guard_enabled"`
...
type ActiveConfig struct {
	...
	LocalJailbreakGuardEnabled bool
	Strategy                   string
	WorkerCount                int
	QueueCapacity              int
	Scanners                   []string
...
type PublicConfig struct {
	...
	StorePassEvents            bool             `json:"store_pass_events"`
	LocalJailbreakGuardEnabled bool             `json:"local_jailbreak_guard_enabled"`
	LocalJailbreakPolicyID     string           `json:"local_jailbreak_policy_id"`
...
func DefaultStorageConfig() storageConfig {
	return storageConfig{
		...
		LocalJailbreakGuardEnabled: true,
		Strategy:                   "priority",
...
func PublicFromStorage(cfg storageConfig, riskControlEnabled bool, invalidTokenEndpointIDs []string) PublicConfig {
	...
	return PublicConfig{
		...
		LocalJailbreakGuardEnabled: cfg.LocalJailbreakGuardEnabled, LocalJailbreakPolicyID: localPromptInjectionPolicyID,
...
func ActiveFromStorage(cfg storageConfig, riskControlEnabled bool, encryptor SecretEncryptor) (ActiveConfig, error) {
	active := ActiveConfig{
		...
		StorePassEvents:        cfg.StorePassEvents, LocalJailbreakGuardEnabled: cfg.LocalJailbreakGuardEnabled, Strategy: cfg.Strategy, WorkerCount: cfg.WorkerCount,
...
func changeSummary(cfg storageConfig) string {
	summary := struct {
		...
		StorePassEvents: cfg.StorePassEvents, LocalJailbreakGuardEnabled: cfg.LocalJailbreakGuardEnabled,
		EndpointCount: len(cfg.Endpoints), ScannerCount: len(cfg.Scanners), AllGroups: cfg.AllGroups,
		GroupCount: len(cfg.GroupIDs), GroupHash: "",
	}
