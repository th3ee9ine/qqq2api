...
func convertResponsesInputToAnthropic(instructions string, inputRaw json.RawMessage, preserveThinkingOpt ...bool) (json.RawMessage, []AnthropicMessage, error) {
	preserveThinking := len(preserveThinkingOpt) > 0 && preserveThinkingOpt[0]
