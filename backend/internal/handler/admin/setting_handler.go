...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		OpenAICodexTurnStateAutoIntervalMinutes:                settings.OpenAICodexTurnStateAutoIntervalMinutes,
		OpenAICodexTurnStateProxyURLs:                          settings.OpenAICodexTurnStateProxyURLs,
		OpenAICodexTurnStateProxyURLsValid:                     settings.OpenAICodexTurnStateProxyURLsValid,
		OpenAICodexTurnStateProxyPoolConfigured:                settings.OpenAICodexTurnStateProxyPoolConfigured,
		OpenAICodexTurnStateProxyPoolCount:                     settings.OpenAICodexTurnStateProxyPoolCount,
		OpenAICodexTurnStateProxyIDs:                           settings.OpenAICodexTurnStateProxyIDs,
		OpenAICodexTurnStateProxyID:                            settings.OpenAICodexTurnStateProxyID,
		OpenAICodexTurnStateProxyIDsValid:                      settings.OpenAICodexTurnStateProxyIDsValid,
