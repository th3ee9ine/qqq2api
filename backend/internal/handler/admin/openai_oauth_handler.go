...
func (h *OpenAIOAuthHandler) RunSessionsCleanup(c *gin.Context) {
	...
	if err := checkExplicitAccountOwnership(c.Request.Context(), h.adminService, accountIDs); err != nil {
		response.ErrorFrom(c, err)
		return
	}
...
func (h *OpenAIOAuthHandler) RefreshAccountToken(c *gin.Context) {
	...
	response.Success(c, accountAdminAccountResponse(c.Request.Context(), dto.AccountFromService(updatedAccount)))
}
...
func (h *OpenAIOAuthHandler) CreateAccountFromOAuth(c *gin.Context) {
	...
	response.Success(c, accountAdminAccountResponse(c.Request.Context(), dto.AccountFromService(account)))
}
...
func (h *OpenAIOAuthHandler) CreateShadow(c *gin.Context) {
	...
	response.Success(c, accountAdminAccountResponse(c.Request.Context(), dto.AccountFromServiceShallow(shadow)))
}
...
func (h *OpenAIOAuthHandler) ResetQuota(c *gin.Context) {
	...
	if postResult.Account != nil {
		resetResponse.Account = accountAdminAccountResponse(c.Request.Context(), dto.AccountFromService(postResult.Account))
	}
