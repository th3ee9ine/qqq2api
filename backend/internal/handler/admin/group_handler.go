...
import (
	...
	"github.com/th3ee9ine/qqq2api/internal/platform/liveattestation"
...
type CreateGroupRequest struct {
	...
	Description               string                        `json:"description"`
	Platform                  string                        `json:"platform" binding:"omitempty,oneof=anthropic openai grok composite"`
...
type CompositeRouteRequest struct {
	...
	TargetPlatform string `json:"target_platform" binding:"required,oneof=anthropic openai grok"`
