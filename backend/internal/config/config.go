...
// Gateway upstream connection-establishment defaults cover DNS/TCP dialing
// and TLS handshakes only; they do not limit a response stream's lifetime.
const (
...
type GatewayCodexTurnStateConfig struct {
	...
	ExpectedBlocks        int   `mapstructure:"expected_blocks"`
	MaxEntries            int   `mapstructure:"max_entries"`
	MaxTokenBytes         int   `mapstructure:"max_token_bytes"`
	MaxProbeResponseBytes int64 `mapstructure:"max_probe_response_bytes"`
	HoldActive            bool  `mapstructure:"hold_active"`
}
...
func setDefaults() {
	...
	viper.SetDefault("gateway.codex_turn_state.max_entries", 2048)
	viper.SetDefault("gateway.codex_turn_state.max_token_bytes", 2048)
	viper.SetDefault("gateway.codex_turn_state.max_probe_response_bytes", 256*1024)
	viper.SetDefault("gateway.codex_turn_state.hold_active", false)
