...
func TestListOllamaCloudUsageGroupAccountsUsesOneStrictBatchQuery(t *testing.T) {
	...
	require.Contains(t, query, "platform IN ('openai', 'anthropic', 'kimi', 'zhipu', 'minimax')")
...
func TestListDueOllamaCloudUsageAccountsFiltersOrdersAndLimits(t *testing.T) {
	...
	for _, clause := range []string{
		"deleted_at IS NULL",
		"status = 'active'",
		"platform IN ('openai', 'anthropic', 'kimi', 'zhipu', 'minimax')",
		"type = 'apikey'",
...
func TestBulkUpdateOllamaIdentityCleanupIsValueConditional(t *testing.T) {
	...
	require.NotContains(t, query, "~*")
	require.Contains(t, query, "platform IN ('openai', 'anthropic', 'kimi', 'zhipu', 'minimax') AND type = 'apikey'")
...
func TestUpdateCredentialsPlainCNAPIKeyAccountCleanupStaysSemanticallyEquivalent(t *testing.T) {
	...
	require.Contains(t, query,
		"platform IN ('openai', 'anthropic', 'kimi', 'zhipu', 'minimax') AND type = 'apikey' AND credentials IS DISTINCT FROM $1::jsonb")
	require.Contains(t, query,
