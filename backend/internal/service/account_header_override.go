...
// 请求头覆写（header override）：对 Anthropic / OpenAI / Kimi / Zhipu
...
// Anthropic / OpenAI / Kimi / Zhipu 仅开放 api_key 账号；
// Grok 额外开放 oauth 账号——
...
func (a *Account) IsHeaderOverrideEligible() bool {
	...
	switch a.Platform {
	case PlatformAnthropic, PlatformOpenAI, PlatformKimi, PlatformZhipu, PlatformMiniMax, PlatformOpenCodeGo:
