...
func TestBuildCodexModelsManifestForGroupUsesDeepSeekVisionCapabilities(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "retired native DeepSeek does not advertise vision", platform: PlatformDeepseek,
		...
		{
			name: "retired Composite DeepSeek alias does not advertise vision", platform: PlatformComposite,
			accounts:   []Account{newAccount(1, PlatformDeepseek, visionModel, nil)},
			modalities: []any{"text"},
		},
		{
