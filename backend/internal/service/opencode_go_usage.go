...
var (
	...
	ErrOpenCodeGoUsageAccountInvalid = infraerrors.BadRequest(
		...
		"account must be an OpenCode Go platform subscription (go mode) account, or an API key account under openai/anthropic/kimi/zhipu/minimax with base_url pointing at the official OpenCode Go base URLs",
	)
