...
import (
	...
	"github.com/th3ee9ine/qqq2api/internal/server/routes"
	"github.com/th3ee9ine/qqq2api/internal/service"
	"github.com/th3ee9ine/qqq2api/internal/web"
...
func SetupRouter(
	...
	// 注册路由
	registerRoutes(r, handlers, jwtAuth, adminAuth, apiKeyAuth, auditLog, stepUpAuth, apiKeyService, opsService, settingService, compositeResolver, cfg, redisClient)
...
func registerRoutes(
	...
	// 面板 API 限流器：认证接口按管理员会话主体、公开接口按安全客户端 IP，
