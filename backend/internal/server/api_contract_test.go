		...
		},
		{
			...
			wantJSON: `{
				...
				"data": {
					...
					"default_platform_quotas": {"anthropic":{"daily":null,"weekly":null,"monthly":null},"openai":{"daily":null,"weekly":null,"monthly":null}},
...
func newContractDeps(t *testing.T) *contractDeps {
	...
	adminService := service.NewAdminService(
		...
		proxyRepo,
		apiKeyRepo,
		nil, // redeem code repository is retired from the local admin surface
