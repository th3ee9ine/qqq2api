...
import (
	...
	"github.com/th3ee9ine/qqq2api/ent/batchimageevent"
	"github.com/th3ee9ine/qqq2api/ent/batchimageitem"
	"github.com/th3ee9ine/qqq2api/ent/batchimagejob"
	"github.com/th3ee9ine/qqq2api/ent/channelmonitor"
	"github.com/th3ee9ine/qqq2api/ent/channelmonitordailyrollup"
	...
	"github.com/th3ee9ine/qqq2api/ent/idempotencyrecord"
	...
	"github.com/th3ee9ine/qqq2api/ent/schema"
	...
	"github.com/th3ee9ine/qqq2api/ent/usagecleanuptask"
...
func init() {
	...
	// userDescSupplyRateMultiplier is the schema descriptor for supply_rate_multiplier field.
	userDescSupplyRateMultiplier := userFields[22].Descriptor()
	// user.DefaultSupplyRateMultiplier holds the default value on creation for the supply_rate_multiplier field.
	user.DefaultSupplyRateMultiplier = userDescSupplyRateMultiplier.Default.(float64)
	// user.SupplyRateMultiplierValidator is a validator for the "supply_rate_multiplier" field. It is called by the builders before save.
	user.SupplyRateMultiplierValidator = userDescSupplyRateMultiplier.Validators[0].(func(float64) error)
